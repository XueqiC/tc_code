...
- Student: `google/gemma-4-12B-it` (dense 11.95B, Apache-2.0, native tool calling).
  Base scores: ALFWorld valid_seen 56.43, WebShop score 53.65 / SR 18.2, BFCL v4 45.63.
...
| WebShop | test sessions 0–499, full 1.18M-product index, ReAct 1-shot prompt of tools/webshop_eval.py (obs 2500 chars, history 600 chars, prompt ≤60k chars) | 15 | greedy (T=0, max_tokens 128) | success rate (reward = 1); score (100·mean reward) as diagnostic |
