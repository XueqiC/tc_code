...
for i in $(seq 1 54); do
  left=0
  for spec in ALT1s0:all87_1alt_v2/seed-0 ALT1s1:all87_1alt_v2/seed-1 PER2s0:all87_2per_v2/seed-0 PER2s1:all87_2per_v2/seed-1 ALT1MINs0:all87_1min_v2/seed-0; do
