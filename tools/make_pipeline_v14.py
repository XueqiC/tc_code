...
ital(0.95, 0.32, 5.4, "Stage I — skill extraction & budget allocation", size=20,
     align=PP_ALIGN.LEFT)
...
box(0.60, 5.28, 4.40, 0.58, PALEY, RGBColor(0xB8,0x8A,0x2E), lw=1.6,
    radius=0.18, text="per-skill token budget  =  w · b", size=19.5,
...
ital(7.40, 0.32, 5.9, "Stage II — budgeted acquisition (×R rounds)",
...
box(11.05, 3.10, 0.54, 0.54, REDL, WHITE, lw=1.3, shape=MSO_SHAPE.OVAL,
    radius=None, text="✗", size=18.3, tcolor=WHITE, bold=True)
label(11.72, 3.18, 1.6, 0.36, "waste 2–4%", size=14.5, color=DARK,
...
prs.save("paper/figs/fig1_pipeline_v14.pptx")
print("saved")
