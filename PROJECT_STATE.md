...
- **hpg**:A 80/76/78 = 78.0(base 81.0);**ALT1 85/85/88 = 86.0**(A +8.0,base +5.0);原版 SmartAD 82/80/81 = 81.0;原版 SAD 69/82/76 = 75.7 → 身份效应在第三个平台成立,ALT1 高出原版 SmartAD 5.0、原版 SAD 10.3。
